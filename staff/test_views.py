...
class StaffTestViews(TestCase):
    ...
    def test_staff_page_with_no_query(self):
        ...
        self.client.login(username="superuser", password="zahur")
    ...
    def test_sick_leave_view_with_superuser_for_different_year_existing_leave_dates(
        self,
    ):
        self.user = User.objects.create_superuser(
            username="superuser", password="zahur"
        ...
        leave = AnnualLeave.objects.create(
            id=2, staff_id=1, start_date="2022-10-5", end_date="2022-10-6", days=5
        )
        data = {
    ...
    def test_sick_leave_view_with_superuser_for_different_year_existing_sick_dates_with_overlap(
        self,
    ):
        self.user = User.objects.create_superuser(
            username="superuser", password="zahur"
    ...
    def test_sick_leave_view_with_superuser_for_different_year_existing_sick_dates_no_overlap(
        self,
    ):
        self.user = User.objects.create_superuser(
            username="superuser", password="zahur"
    ...
    def test_sick_leave_view_with_superuser_for_actual_year_existing_leave_dates(self):
        ...
        self.client.login(username="superuser", password="zahur")
        leave = AnnualLeave.objects.create(
            id=2, staff_id=1, start_date="2021-10-5", end_date="2021-10-6", days=5
        )
        data = {
            "start_date": "10/05/2021",
            "end_date": "10/10/2021",
    ...
    def test_sick_leave_view_with_superuser_for_actual_year_existing_sick_dates_no_overlap(
        self,
    ):
        self.user = User.objects.create_superuser(
            username="superuser", password="zahur"
    ...
    def test_annual_leave_view_with_superuser_for_different_year_existing_leave_dates(
        self,
    ):
        self.user = User.objects.create_superuser(
            username="superuser", password="zahur"
    ...
    def test_annual_leave_view_with_superuser_for_different_year_existing_sick_dates_with_overlap(
        self,
    ):
        self.user = User.objects.create_superuser(
            username="superuser", password="zahur"
    ...
    def test_annual_leave_view_with_superuser_for_different_year_existing_sick_dates_no_overlap(
        self,
    ):
        self.user = User.objects.create_superuser(
            username="superuser", password="zahur"
    ...
    def test_annual_leave_view_with_superuser_for_different_with_no_existing_leave(
        self,
    ):
        self.user = User.objects.create_superuser(
            username="superuser", password="zahur"
    ...
    def test_annual_leave_view_with_superuser_for_actual_year_existing_leave_dates(
        self,
    ):
        self.user = User.objects.create_superuser(
            username="superuser", password="zahur"
    ...
    def test_annual_leave_view_with_superuser_for_actual_year_existing_sick_dates_no_overlap(
        self,
    ):
        self.user = User.objects.create_superuser(
            username="superuser", password="zahur"
    ...
    def test_annual_leave_taken_view_with_superuser_query_All(self):
        ...
        response = self.client.get(
            reverse("annual_leave_taken", args=[1]), {"q": "All"}
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_annual_leave_taken_view_with_superuser_query_year(self):
        ...
        self.client.login(username="superuser", password="zahur")
        response = self.client.get(
            reverse("annual_leave_taken", args=[1]), {"q": "2021"}
        )
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "staff/annual_leave_taken.html")
    ...
    def test_sick_leave_modify_view_with_superuser_invalid_dates(self):
        ...
        self.client.login(username="superuser", password="zahur")
        sick = SickLeave.objects.create(
            id=1, staff_id=1, start_date="2021-01-01", end_date="2021-01-05", days=6
        )
        data = {
            "start_date": "10/01/2021",
            "end_date": "10/01/2022",
    ...
    def test_sick_leave_modify_view_with_superuser_different_year_with_overlap(self):
        ...
        self.client.login(username="superuser", password="zahur")
        sick = SickLeave.objects.create(
            id=1, staff_id=1, start_date="2022-01-01", end_date="2022-01-05", days=6
        )
        sick_two = SickLeave.objects.create(
            id=2, staff_id=1, start_date="2022-05-01", end_date="2022-05-05", days=6
        )
        leave = AnnualLeave.objects.create(
            id=2, staff_id=1, start_date="2022-05-01", end_date="2022-05-05", days=6
        )
    ...
    def test_sick_leave_modify_view_with_superuser_same_year_with_overlap(self):
        ...
        sick_two = SickLeave.objects.create(
            id=2, staff_id=1, start_date="2021-05-01", end_date="2021-05-05", days=6
        )
        leave = AnnualLeave.objects.create(
            id=2, staff_id=1, start_date="2021-05-01", end_date="2021-05-05", days=6
        )
    ...
    def test_sick_leave_modify_view_with_superuser_same_year_leave_no_overlapping(self):
        ...
        self.client.login(username="superuser", password="zahur")
        leave = AnnualLeave.objects.create(
            id=2, staff_id=1, start_date="2021-04-01", end_date="2021-04-05", days=6
        )
        sick = SickLeave.objects.create(
            id=1, staff_id=1, start_date="2021-05-01", end_date="2021-05-01", days=6
        )
        data = {
    ...
    def test_annual_leave_modify_view_with_superuser_different_year_with_no_overlap(
        self,
    ):
        self.user = User.objects.create_superuser(
            username="superuser", password="zahur"
    ...
    def test_annual_leave_modify_view_with_superuser_same_year_leave_no_overlapping(
        self,
    ):
        self.user = User.objects.create_superuser(
            username="superuser", password="zahur"
        ...
        self.client.login(username="superuser", password="zahur")
        leave = AnnualLeave.objects.create(
            id=1, staff_id=1, start_date="2021-04-01", end_date="2021-04-05", days=6
        )
        sick = SickLeave.objects.create(
            id=1, staff_id=1, start_date="2021-05-01", end_date="2021-05-01", days=6
        )
    ...
    def test_sick_delete_view_with_superuser_with_not_same_year(self):
        ...
        self.client.login(username="superuser", password="zahur")
        sick = SickLeave.objects.create(
            id=1, staff_id=1, start_date="2022-05-01", end_date="2022-05-01", days=6
        )
        response = self.client.get(reverse("sick_delete", args=[1]))
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(response, "/staff/sick_leave_taken/1")
    ...
    def test_annual_leave_planner_view_with_superuser_with_query_and_month(self):
        ...
        self.client.login(username="superuser", password="zahur")
        annual = AnnualLeave.objects.create(
            id=1, staff_id=1, start_date="2021-05-30", end_date="2021-06-02", days=6
        )
        response = self.client.get(
            reverse("leave_planner"), {"q": "2021", "month": "5"}
        )
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "staff/leave_planner.html")
    ...
    def test_annual_leave_planner_view_with_superuser_with_query_and_same_month(self):
        ...
        self.client.login(username="superuser", password="zahur")
        annual = AnnualLeave.objects.create(
            id=1, staff_id=1, start_date="2021-05-20", end_date="2021-05-25", days=6
        )
        response = self.client.get(
            reverse("leave_planner"), {"q": "2021", "month": "5"}
        )
