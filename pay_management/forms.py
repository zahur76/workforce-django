...
class add_salaryForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["non_taxable_additional_allowances"].widget.attrs[
            "autofocus"
        ] = True
        for field in self.fields:
            ...
            self.fields[field].widget.attrs[
                "class"
            ] = "border-dark rounded-0 mx-auto add-salary-form-input m-1"
            ...
            self.fields[
                "non_taxable_additional_allowances"
            ].label = "Non taxable additional allowances"
            self.fields[
                "taxable_additional_allowances"
            ].label = "Taxable additional allowances"
